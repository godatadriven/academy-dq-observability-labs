...
- `python agent_tools.py read <day>` gives yesterday's takings, for the morning of <day>.
- `python agent_tools.py order <kg> "<reason>"` places tomorrow's order of ingredients.
